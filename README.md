...
**AI support ticket triage** *(in progress)* — classifies and routes incoming tickets by 
category, priority, and urgency, with human-in-the-loop for low-confidence cases.
